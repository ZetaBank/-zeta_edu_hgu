...
-   Rename the untitiled python file to ``02_12-2. tao_facedetect_camera.py``
...
-   Open the ``02_12-3. tao_facedetect_camera.ipynb`` notebook.

.. thumbnail:: /_images/courses/course_2/ai_tao/facedetect_camera.png
...
-   Check if your python notebook can read the python code you have written:
    ...
    .. code-block:: python
        ...
        !cat /home/zeta/notebook/lecture/'2.AI Training Examples'/'02_12-2. tao_facedetect_camera.py'


-   Execute the tao_facedetect_camera python code. 
    ...
    *Note* that we are setting our major functions,
    ...
    .. code-block:: python
        ...
        !python3 /home/zeta/notebook/lecture/'2.AI Training Examples'/'02_12-2. tao_facedetect_camera.py' $CAMERA
